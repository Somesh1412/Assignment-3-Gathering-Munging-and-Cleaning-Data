...
mycursor.execute("Create Table Requirements(University_ID int NOT NULL, Year int NOT NULL, Score int, GRE int, TOEFL int, SOP numeric(9,2), LOR numeric(9,2), CGPA numeric(9,2), Research int, FOREIGN KEY (University_ID) REFERENCES University(University_ID))")
